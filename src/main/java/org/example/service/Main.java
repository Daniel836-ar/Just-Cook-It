...
//приправы|соусы
        ...
        List<Amount> amount_eggs_and_tomato = new ArrayList<>(Arrays.asList(new Amount(3, ingredient_chickenEgg),new Amount(1, ingredient_tomato)));
        ...
        Recipe recipe_eggs_andrice = new Recipe("Яйца с рисом","два яйца на сковороду и жарить на среднем огне 5 минут, а потом добавить готовую гречку", amount_eggs_and_rice);
